...
var getNodeRenderOptions = exports.getNodeRenderOptions = (0, _reselect.createSelector)(function (node) {
...
var NODE_CHANGE_OPERATIONS = {
  CHANGE_NODE: function CHANGE_NODE(nodes, updatedNode) {
    return nodes.map(function (n) {
      return n.id === updatedNode.id ? (0, _lodash2.default)(_extends({}, updatedNode, n.children && { children: [].concat(n.children) }), FLATTEN_TREE_PROPERTIES) : n;
    });
  },
