...
var isNodeExpanded = exports.isNodeExpanded = function isNodeExpanded(node) {
  return node.state && node.state.expanded;
};
var nodeHasChildren = exports.nodeHasChildren = function nodeHasChildren(node) {
...
var getFlattenedTreePaths = exports.getFlattenedTreePaths = function getFlattenedTreePaths(nodes) {
  var parents = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
...
var doesChangeAffectFlattenedTree = exports.doesChangeAffectFlattenedTree = function doesChangeAffectFlattenedTree(previousNode, nextNode) {
