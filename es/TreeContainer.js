...
(_DEFAULT_UPDATE_TYPES[UPDATE_TYPE.DELETE] = deleteNodeFromTree),
(_DEFAULT_UPDATE_TYPES[UPDATE_TYPE.UPDATE] = replaceNodeFromTree),
_DEFAULT_UPDATE_TYPES);

var getExtensions = createSelector(
  function(e) {
    return e;
  },
  function() {
